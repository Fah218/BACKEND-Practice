...
-Set up backend first -Install express and created a sample index.js
...
-create a routes (item,js) >> to keep differnet routes and place the actual index.js clean to look -create custom route for birds.js and set up into index.js for clean struct
